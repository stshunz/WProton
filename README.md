...
Notas
bash, curl, tar
Presentes en cualquier distro
fusermount3 (paquete fuse3)
Del sistema
squashfuse, fuse-overlayfs
Pueden ir junto al script (portables) o en el sistema
mksquashfs (squashfs-tools)
Solo para importar/empaquetar
7z (p7zip)
Solo para importar .7z/.rar
zenity
Opcional (diálogos en escritorio)
Python + pygame
Se auto-instalan portables con --setup
evdev (Python)
Para el mapeador .keys: --setup lo compila (CachyOS); en SteamOS/Deck copia tu carpeta evmapy/ a la raíz de WProton
...
Botón
Acción
Dpad / stick izquierdo
Moverse
A / Start
Elegir / entrar
B
Volver / subir carpeta / limpiar búsqueda
X
Marcar casilla (listas de opciones) / borrar letra (búsqueda)
Y
